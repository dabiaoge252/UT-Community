...
public class TodayNoteCollectIncrementData2DBConsumer implements RocketMQListener<String> {
    ...
    public void onMessage(String body) {
        ...
        // 消息体 JSON 字符串转 DTO
        CollectUnCollectNoteMqDTO uncollectNoteMqDTO = JsonUtils.parseObject(body, CollectUnCollectNoteMqDTO.class);
        ...
        // 笔记的发布者 ID
        Long noteCreatorId = uncollectNoteMqDTO.getNoteCreatorId();
